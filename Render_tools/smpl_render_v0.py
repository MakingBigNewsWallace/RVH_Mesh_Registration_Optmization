...
video_id = "dynvideo_male"
root ="D:\MWORK1.2\HSL\wholebody_fitting\Render_tools\datas\cuhk_garment/female-anran-apose"
...
# smpl_params = torch.load(os.path.join(root, "smpl_parms.pth"))
...
smpl_params = load_smpl_param(os.path.join(root, "poses_refined.npz"))
...
for framed_index in tqdm.tqdm(range(global_orient.shape[0])):
    ...
    ## save image
    output_path = f"./output/test_video/{id_str}.jpg"
